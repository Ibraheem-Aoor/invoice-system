        ...
        <ul class="side-menu">
            ...
            @can('الفواتير')
                ...
                <li class="slide">
                    ...
                    @can('قائمة الفواتير')
                        <ul class="slide-menu">
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'invoices-list')) }}">قائمة
                                    الفواتير</a>
                            </li>
                        @endcan

                        @can('الفواتير المدفوعة')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'invoices-fully-paid')) }}">الفواتير
                                    المدفوعة</a>
                            </li>
                        @endcan

                        @can('الفواتير الغير مدفوعة')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'invoices-not-paid')) }}">الفواتير
                                    الغير
                                    مدفوعة</a></li>
                        @endcan

                        @can(' الفواتير المدفوعة جزئيا')
                            <li><a class="slide-item">الفواتير المدفوعة
                                    جزئيا</a></li>
                        @endcan

                        @can('ارشيف الفواتير')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'invoices-archived')) }}">أرشيف
                                    الفواتير
                                </a></li>
                        @endcan
            ...
            @can('التقارير')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        @can('تقرير العملاء')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'cleints-reoprts')) }}">تقارير
                                    العملاء</a>
                            </li>
                        @endcan
