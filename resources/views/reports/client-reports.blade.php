    ...
    <div class="col-xl-12">
        <div class="card mg-b-20">
            ...
            <div class="card-header pb-0">
                ...
                <form action="{{ route('cleints.search') }}" method="post" role="search" autocomplete="off">
                    @csrf
                        ...
                        <div class="col">
                            ...
                            <select name="Section" class="form-control select2" onclick="console.log($(this).val())"
                                ...
                                @if (isset($old_section))
                                    <option value="{{ $old_section }}" selected>{{ $old_section->section_name }}
                                    </option>
                                @endif
                                @if (isset($sections))
                                    @foreach ($sections as $section)
                                        @if (isset($old_section) && $section->id == $old_section->id)
                                            @continue
                                        @endif
